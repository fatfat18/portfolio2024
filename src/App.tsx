...
const App = () => {
  ...
  return (
    <Router>
      <div className="font-outfit bg-zinc-900 min-h-screen flex justify-center items-center p-4 gap-4">
        <div className="bg-zinc-800 min-h-screen rounded-md w-1/4 flex flex-col items-center " data-aos="fade-left" data-aos-duration="500" data-aos-delay="500">
          ...
          <br />
          <div className="w-full text-center  text-white text-2xl " data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="800">
            John Patrick Pahunang
          </div>
          <br />
          <div className="w-3/4 text-center " data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="850">
            <span className="text-white text-md bg-zinc-700 p-2 px-4 rounded-lg"> Software Engineer</span>
          </div>
        ...
        <div className="bg-zinc-800 min-h-screen w-3/4 rounded-md flex flex-col " data-aos="fade-right" data-aos-duration="500" data-aos-delay="600">
          <div className="flex justify-between items-center  w-full h-1/6 font-medium ">
            <div className=" pl-10 text-white tracking-widest h-full flex items-end justify-end text-2xl">{route}</div>
            <div className="flex bg-zinc-700 px-10 py-4 text-white rounded-bl-xl rounded-tr-md w-max gap-10">
              <Link to="/" onClick={() => handleRoute("About")}>
                <div className="cursor-pointer px-4 py-2 border-b-2 border-zinc-700 hover:border-b-2 hover:border-white transition duration-300 ">About</div>
              </Link>
              <Link to="/resume" onClick={() => handleRoute("Resume")}>
                <div className="cursor-pointer px-4 py-2 border-b-2 border-zinc-700 hover:border-b-2 hover:border-white transition duration-300">Resume</div>
              </Link>
              <Link to="/portfolio" onClick={() => handleRoute("Portfolio")}>
                <div className="cursor-pointer px-4 py-2 border-b-2 border-zinc-700 hover:border-b-2 hover:border-white transition duration-300">Portfolio</div>
              </Link>
              <Link to="/contact" onClick={() => handleRoute("Contact")}>
                <div className="cursor-pointer px-4 py-2 border-b-2 border-zinc-700 hover:border-b-2 hover:border-white transition duration-300 ">Contact</div>
              </Link>
            </div>
          </div>
